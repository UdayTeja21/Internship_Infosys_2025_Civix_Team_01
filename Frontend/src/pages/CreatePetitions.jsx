...
// // This component will be displayed in the center of the screen on success.
...
//   // NEW: State to control the visibility of the success popup
...
//         // 1. Show the success popup instead of an alert
//         setShowSuccessPopup(true);
        
//         // 2. Wait 2 seconds, then navigate to the petitions page
//         setTimeout(() => {
//           navigate('/petitions');
//         }, 2000);
//       }
...
//   return (
//     <>
//       {/* This will render the popup when showSuccessPopup is true */}
//       {showSuccessPopup && (
//         <SuccessPopup
//           message="Petition Created Successfully!"
//           onClose={() => navigate('/petitions')} // Also navigate if user clicks close
//         />
//       )}
  ...
  return (
    <>
      {showSuccessPopup && (
        <SuccessPopup
          message="Petition Created Successfully!"
          onClose={() => navigate('/dashboard')} // ✅ CHANGED
        />
      )}
